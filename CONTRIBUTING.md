...
1. Make an [Issue](https://github.com/xacce/troupe/issues/new)
...
```json
    {
        "dependencies": {
            "com.xacce.troupe": "https://github.com/YOUR_USER/troupe.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at thisice@gmail.com.
